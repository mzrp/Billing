...
if (document.getElementById('subinfodiv1')) {
    ...
    function(t, e, o) {
        ...
        function i() {
            ...
            return b["default"].get(d["default"].API_HOST + "/api/nav/customers")
        }

        function l() {
            var t = n("products");
            //return t ? Promise.resolve(t) : b["default"].get(d["default"].API_HOST + "/api/nav/products")
            return b["default"].get(d["default"].API_HOST + "/api/nav/products")
        }
            ...
            return i(e, t), l(e, [{
                ...
                value: function() {
                    return c["default"].createElement("ul", {
                        ...
                        //text: "Bulk Update Names",
                        //icon: "add",
                        //to: "/api/nav/customernames"
                    //}), c["default"].createElement(y, {
                       // text: "Bulk Update Prices",
                        //icon: "add",
                        //to: "/api/nav/productprices"
                    //}), 
			c["default"].createElement(x, {
    ...
    function(t, e, o) {
        ...
        var a = o(2),
            ...
            A = o(361),
            z = r(A),
            M = (0, z["default"])("https://billing.gowingu.net/TeleBilling(v02)"),
            M2 = (0, z["default"])("https://billing.gowingu.net/HarvestImportDF.aspx"),
            M3 = (0, z["default"])("https://billing.gowingu.net/TimeLogImportDF.aspx"),
        ...
        var L = n["default"].createElement(s.Router, {
            ...
            path: l["default"].BASEURL + "api/nav/customernames",
            component: D5
        }),n["default"].createElement(s.Route, {
            path: l["default"].BASEURL + "api/nav/productprices",
            component: D6
        }),n["default"].createElement(s.Route, {
            ...
            path: l["default"].BASEURL + "telebilling",
            component: M
        }), n["default"].createElement(s.Route, {
            path: l["default"].BASEURL + "harvest",
            component: M2
        }), n["default"].createElement(s.Route, {
            ...
            path: l["default"].BASEURL + "hitbilling",
            component: D2
        }), n["default"].createElement(s.Route, {
            ...
            path: l["default"].BASEURL + "dashboard",
            component: M5
        })
        ));
        e["default"] = L
    ...
    function(t, e, o) {
        ...
        var r = {};
        r.API_HOST = "https://billing.gowingu.net/RPBilling", r.BASEURL = "/RPBilling/", e["default"] = r
    },
    function(t, e) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
                ...
                return l(e, t), c(e, [{
                    ...
                    value: function() {
                        ...
                        return this.state.alert && (e = p["default"].createElement("div", {
                            ...
                            key: "default"
                        }, "pick one ..."), (0, f["default"])(this.props.products, function(t) {
                            return p["default"].createElement("option", {
                                key: t.number,
                                value: t.number
                            }, t.name, " (", t.number.toString().substring(0, 4) + "." + t.number.toString().substring(4, 7), ")")
	...
	request.open('GET', 'https://billing.gowingu.net/RPBilling/api/subinfosums', false); 
	request.send(null);
	...
	if (request.status === 200) {
		...
		subsinfo = subsinfo.replace("Monthly", "<a href='https://billing.gowingu.net/RPBilling/hosting/subscriptions/?f=monthly'>Monthly</a>");
		subsinfo = subsinfo.replace("Quaterly", "<a href='https://billing.gowingu.net/RPBilling/hosting/subscriptions/?f=quaterly'>Quaterly</a>");
		subsinfo = subsinfo.replace("Annually", "<a href='https://billing.gowingu.net/RPBilling/hosting/subscriptions/?f=annually'>Annually</a>");
		subsinfo = subsinfo.replace("Biannually", "<a href='https://billing.gowingu.net/RPBilling/hosting/subscriptions/?f=biannually'>Biannually</a>");
		subsinfo = subsinfo.replace("All", "<a href='https://billing.gowingu.net/RPBilling/hosting/subscriptions'>All</a> (<a href='https://billing.gowingu.net/RPBilling/hosting/subscriptions/?f=all'>Alphabetically</a>)");
		...
		var ddDT = String(FirstDayOfNextMonth.getDate()).padStart(2, '0');
		var mmDT = String(FirstDayOfNextMonth.getMonth() + 1).padStart(2, '0'); //January is 0!
		var yyyyDT = FirstDayOfNextMonth.getFullYear();

		var sTodayDT = yyyyDT + '-' + mmDT + '-' + ddDT;
		
		
		subsinfo += " <a href='https://billing.gowingu.net/RPBilling/api/nav/pushnow?date=" + sTodayDT + "&billcycle=Monthly' target='_blank'>Push All Monthly</a> |";
		subsinfo += " <a href='https://billing.gowingu.net/RPBilling/api/nav/pushnow?date=" + sTodayDT + "&billcycle=Quaterly' target='_blank'>Push All Quaterly</a> |";
