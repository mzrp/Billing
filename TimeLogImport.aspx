<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimeLogImport.aspx.cs" Inherits="RPNAVConnect.Default" %>
...
<body>
    <form id="RPNAVConnectForm" runat="server">
		    ...
		    <div id="sideNav" href=""><i class="fa fa-caret-right"></i></div>
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="active-menu" href="TimeLogImport.aspx"><i class="fa fa-desktop"></i> TimeLog</a>
                        </li>
    					<li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-header">
                                TimeLog To Nav Import <small></small>
                            </h1>
                        </div>
                    </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div style="margin-left:10px; padding-left:10px; border-style: solid; border-width: 0px;">    
                                        Please select CVR and date period
                                    </div>
                                </div>
        ...
        <div style="margin:10px; padding:10px; border-style: solid; border-width: 0px;">            
            ...
            <asp:TextBox ID="VATNoTB" runat="server" Width="500px" Visible="true"></asp:TextBox>
            <!--
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:Button ID="TimeLogDataB" runat="server" Text="Hent data fra TimeLog" OnClientClick="invokeLoader();" OnClick="TimeLogDataB_Click" Height="58px" Width="286px" />
            <br />
            <br />
            <asp:Label ID="TimeLogDataL" runat="server" Text=""></asp:Label>
