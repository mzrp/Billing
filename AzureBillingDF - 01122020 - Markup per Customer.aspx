<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="AzureBillingDF.aspx.cs" Inherits="RPNAVConnect.AzureBillingDF" %>
        ...
        <div id="wrapper">
            <div class="panel-body">
                <div style="margin:10px; padding:10px; border-style: solid; border-width: 0px;">     
                    ...
                    <font size="3"><b><asp:Label ID="TLInfoLabel" runat="server" Text="MICROSOFT PARTNER CENTER"></asp:Label></b></font>
                    <br /><br />
                    ...
                    <br /><br />
                        ...
                        <a href="javascript:toogleMarkup();" id="tmlink">Close Reseller Percentage</a> 

                        <div id="resellermarkup" style='display: inline;' ">
                            <br /><br />
                            <asp:ListView ID="CustomersMarkup" runat="server">
                                ...
                                <ItemTemplate>  
                                    <tr>  
                                        <td><%# Eval("Name")%></td>  
                                        <td><asp:TextBox runat='server' AutoPostBack="True" OnTextChanged="Unnamed_TextChanged" Text='<%# Eval("Markup")%>' CustName='<%# Eval("Name")%>' CustId='<%# Eval("Id")%>' ></asp:TextBox></td>  
                                    </tr>  
                                </ItemTemplate>  
                            </asp:ListView>
                        ...
                        <asp:Button ID="AzureBillingDataB" runat="server" Text="Hent data fra Microsoft Partner Center" OnClientClick="invokeLoader();" Height="58px" Width="286px" OnClick="AzureBillingDataB_Click" />
                        <br />
                        <br />
