<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IPVisionDF.aspx.cs" Inherits="RPNAVConnect.IPVisionDF" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>IPVision To Nav Import</title>
...
<body>
    <form id="IPVsionForm" runat="server">
        ...
        <div style="margin:10px; padding:10px; border-style: solid; border-width: 0px;">       
            ...
            <asp:FileUpload ID="IPVsionFileUpload" runat="server" />

            <br />

            <asp:Button ID="IPVsionB" runat="server" Text="Upload file to server" OnClientClick="invokeLoader();" OnClick="IPVsionB_Click" Height="58px" Width="286px" />


            <br />
            <br />
            <asp:Label ID="IPVsionL" runat="server" Text=""></asp:Label>
            <asp:Label ID="PPSep1" runat="server" Text="<br />"></asp:Label>
            <asp:Button ID="PushIPVsionDataToNavB" runat="server" Text="Import Data To TeleBillingImport" Visible="false" OnClientClick="invokeLoader();" OnClick="PushIPVsionDataToNavB_Click" Height="58px" Width="286px" /> 
            <br />
            <br />
