                    ...
                    foreach (InvoiceLineCollectionModel line in invoice.LineCollections)
                    {
                        ...
                        {                            
                            if (zoneLines.Seconds > 0)
                            {
                                ...
                                zoneCallsLine.No = zoneLines.Minute_No;
                                ...
                                zoneCallsLine.Unit_Price = zoneLines.Minute_price;//Math.Round((zoneCallsLine.Total_Amount_Excl_VAT / zoneCallsLine.Quantity), 4, MidpointRounding.AwayFromZero);
